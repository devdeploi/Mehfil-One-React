        ...
        <div className="sa-login-container">
            <div className="sa-login-card sa-register-mode" style={{ maxWidth: '800px' }}>
                <div className="d-flex align-items-center mb-4">
                    ...
                    <h2 className="sa-login-title m-0 text-start w-auto" style={{ background: 'none', WebkitTextFillColor: 'initial', color: '#fff' }}>Communication Policy</h2>
                </div>
                ...
                <div className="mt-4 text-white-50" style={{ textAlign: 'justify', lineHeight: '1.7' }}>
                    <h4 className="text-white mt-4 mb-3">1. Communication Channels</h4>
                    ...
                    <h4 className="text-white mt-4 mb-3">2. Promotional Messages</h4>
                    ...
                    <h4 className="text-white mt-4 mb-3">3. Privacy & Data Protection</h4>
