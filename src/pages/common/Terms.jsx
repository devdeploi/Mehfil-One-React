        ...
        <div className="sa-login-container">
            <div className="sa-login-card sa-register-mode" style={{ maxWidth: '800px' }}>
                <div className="d-flex align-items-center mb-4">
                    <button className="btn btn-outline-light rounded-circle p-2 me-3" style={{ width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={handleBack}>
                        <FaArrowLeft />
                    </button>
                    <h2 className="sa-login-title m-0 text-start w-auto" style={{ background: 'none', WebkitTextFillColor: 'initial', color: '#fff' }}>Terms and Conditions</h2>
                </div>

                <p className="text-white-50 border-bottom border-white border-opacity-10 pb-3">Last updated: {new Date().toLocaleDateString()}</p>

                <div className="mt-4 text-white-50" style={{ textAlign: 'justify', lineHeight: '1.7' }}>
                    <h4 className="text-white mt-4 mb-3">1. Introduction</h4>
                    ...
                    <h4 className="text-white mt-4 mb-3">2. Vendor Obligations</h4>
                    ...
                    <h4 className="text-white mt-4 mb-3">3. Payments & Subscriptions</h4>
                    ...
                    <h4 className="text-white mt-4 mb-3">4. Limitation of Liability</h4>
